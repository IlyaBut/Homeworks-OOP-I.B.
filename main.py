...
best_lecturer_1 = Lecturer('Гоша', 'Трубчатый')
best_lecturer_1.courses_attached += ['Python']

best_lecturer_2 = Lecturer('Венцеслав', 'Моющий')
best_lecturer_2.courses_attached += ['Java']

cool_reviewer_1 = Reviewer('Жора', 'Пугающий')
cool_reviewer_1.courses_attached += ['Python']
cool_reviewer_1.courses_attached += ['Java']

cool_reviewer_2 = Reviewer('Вадик', 'Промзоновский')
